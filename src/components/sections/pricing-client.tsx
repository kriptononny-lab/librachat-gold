...
export function PricingClient() {
  ...
  return (
    <div style={{ background: "#080808" }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "12px", marginBottom: "52px" }}>
            ...
            <div
              ...
              style={{
                width: "44px", height: "24px", background: "#c9a227",
            ...
            <span style={{
              background: "rgba(201,162,39,0.1)", border: "1px solid rgba(124,58,237,0.25)",
              color: "#e8c84a", fontSize: "11px", fontWeight: 600,
                ...
                >
                  {plan.isPopular && (
                    <div style={{
                      ...
                      background: "#c9a227", color: "#000000", fontSize: "10px", fontWeight: 700,
                  ...
                  <div style={{ fontSize: "11px", color: saving ? "#e8c84a" : "transparent", marginBottom: "20px", height: "16px" }}>
                    {saving ?? ""}
                  </div>
                  <Link href={plan.href}>
                    <button style={{
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "10px", flexGrow: 1 }}>
                    {plan.features.map((f) => (
                      <div key={f.label} style={{
                        ...
                        {f.ok
                          ? <Check size={12} color="#c9a227" style={{ flexShrink: 0, marginTop: "2px" }} />
      ...
      {/* CTA */}
      <section style={{ background: "#080808", padding: "88px 24px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="https://librachat.kz/auth">
              <button style={{
                background: "#c9a227", border: "none", color: "#000000",
