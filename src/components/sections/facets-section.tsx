        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "16px" }}>
          {CARDS[active].map((card) => (
            <div key={card.badge} style={{
              ...
              <div style={{ fontSize: "11px", fontWeight: 600, color: "#e8c84a", marginBottom: "10px", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                {card.badge}
              </div>
              ...
              <div style={{
                ...
                <span style={{ color: "#e8c84a", fontWeight: 600 }}>Супер-сила: </span>{card.superpower}
              </div>
              <Link href={card.href} style={{
                display: "inline-flex", alignItems: "center", gap: "6px",
                fontSize: "12px", fontWeight: 600, color: "#c9a227", textDecoration: "none",
              }}>
                Попробовать →
              </Link>
            </div>
